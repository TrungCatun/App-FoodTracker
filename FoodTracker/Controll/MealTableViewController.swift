...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "MealTableViewCell", for: indexPath)
    ...
    private func loadSampLeMeals() {
        ...
        guard let meal1 = Meal(name: "Cua bien sot ca chua", photo: photo1, rating: 0) else {
            fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal(name: "Banh Mi", photo: photo2, rating: 0) else {
            fatalError("Unable to instantiate meal2")
        }
        
        guard let meal3 = Meal(name: "Nem Ran", photo: photo3, rating: 0) else {
            fatalError("Unable to instantiate meal2")
        }
